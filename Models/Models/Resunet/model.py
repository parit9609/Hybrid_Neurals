...
class ResUNet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        # Encoder
        self.conv1 = self.residual_block(3, 64)
        self.conv2 = self.residual_block(64, 128)
        self.conv3 = self.residual_block(128, 256)
        self.conv4 = self.residual_block(256, 512)
        self.conv5 = self.residual_block(512, 1024)
        # Decoder
        self.upconv6 = self.conv_transpose_block(1024, 512)
        self.conv6 = self.residual_block(1024, 512)
        self.upconv7 = self.conv_transpose_block(512, 256)
        self.conv7 = self.residual_block(512, 256)
        self.upconv8 = self.conv_transpose_block(256, 128)
        self.conv8 = self.residual_block(256, 128)
        self.upconv9 = self.conv_transpose_block(128, 64)
        self.conv9 = self.residual_block(128, 64)
